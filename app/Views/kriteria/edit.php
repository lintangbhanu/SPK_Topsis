...
<body class="dashboard-body">
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            ...
            <form action="/kriteria/update/<?= esc($kriteria['id_kriteria']) ?>" method="post" class="mt-3">
                <div class="mb-3">
                    <label for="id_kriteria" class="form-label">ID Kriteria:</label>
                    <input type="text" id="id_kriteria" name="id_kriteria" value="<?= esc($kriteria['id_kriteria']) ?>" class="form-control" disabled>
                </div>

                <div class="mb-3">
                    <label for="kriteria" class="form-label">Kriteria:</label>
                    <input type="text" id="kriteria" name="kriteria" value="<?= esc($kriteria['kriteria']) ?>" class="form-control" required maxlength="255">
                </div>

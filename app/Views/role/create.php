    ...
    <div class="content">
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                <span class="navbar-brand">Tambah Role</span>
            </div>
        </nav>
                ...
                <div class="card-body">
                    <form action="/role/store" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="id_role" name="id_role" placeholder="Contoh: R1, R2, EXP, GOLD" required>
                            <small class="text-muted">ID Role harus unik</small>
                        </div>
                        <div class="mb-3">
                            <label for="role" class="form-label">Nama Role</label>
                            <input type="text" class="form-control" id="role" name="role" placeholder="Contoh: EXP Laner, Gold Laner" required>
                        </div>

    ...
    <div class="content">
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                <span class="navbar-brand">Edit Role</span>
            </div>
        </nav>
        ...
        <div class="container mt-4">
            <div class="card">
                <div class="card-body">
                    <form action="/role/update/<?= esc($role['id_role']) ?>" method="post">
                        <div class="mb-3">
                            <label for="id_role" class="form-label">ID Role</label>
                            <input type="text" class="form-control" id="id_role" value="<?= esc($role['id_role']) ?>" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="role" class="form-label">Nama Role</label>
                            <input type="text" class="form-control" id="role" name="role" value="<?= esc($role['role']) ?>" required>
                        </div>
